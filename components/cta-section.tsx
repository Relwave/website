...
export function CTASection() {
  return (
    <section className="py-24 px-6 relative overflow-hidden">
      {/* Background Blobs */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-primary/20 blur-[120px] rounded-full -z-10 animate-pulse-glow" />
      ...
      <div className="max-w-5xl mx-auto rounded-[3rem] bg-foreground text-background p-12 md:p-20 relative overflow-hidden border border-border/10 shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <h2 className="text-4xl md:text-6xl font-black mb-6 tracking-tighter">
            Stop Guessing. <br /> Start <span className="text-primary">Version-controlling</span>.
          </h2>
          
          <p className="text-background/60 text-lg md:text-xl max-w-2xl mb-12 leading-relaxed">
            Join 10,000+ developers who manage their databases with the precision of Git. 
            Free for open source. Enterprise-ready for you.
          </p>

          <div className="flex flex-col sm:flex-row gap-4">
            <Button size="lg" variant="default" className="bg-primary text-foreground hover:bg-primary/90 h-14 px-10 text-lg font-bold rounded-full group">
              <Link href="https://github.com/Relwave/relwave-app/releases" className="flex items-center gap-2">
                Download Relwave
                <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="border-background/20 hover:bg-background/10 h-14 px-10 text-lg font-bold rounded-full text-background">
          ...
          <div className="mt-12 flex items-center gap-8 opacity-40 grayscale contrast-200">
            ...
            <div className="text-sm font-bold tracking-widest uppercase">MongoDB</div>
          </div>
        </div>
      </div>
    </section>
